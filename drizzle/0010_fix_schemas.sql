...
ALTER TABLE "authenticators" DROP CONSTRAINT "authenticators_user_id_profiles_id_fk";
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "investments" DROP CONSTRAINT "investments_user_id_profiles_id_fk";
--> statement-breakpoint
ALTER TABLE "readings" DROP CONSTRAINT "readings_user_id_profiles_id_fk";
--> statement-breakpoint
ALTER TABLE "sessions" DROP CONSTRAINT "sessions_user_id_profiles_id_fk";
--> statement-breakpoint
