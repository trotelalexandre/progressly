...
ALTER TABLE "accounts" DROP CONSTRAINT "accounts_user_id_users_uuid_fk";
--> statement-breakpoint
ALTER TABLE "authenticators" DROP CONSTRAINT "authenticators_user_id_users_uuid_fk";
--> statement-breakpoint
ALTER TABLE "budgets" DROP CONSTRAINT "budgets_user_id_users_uuid_fk";
--> statement-breakpoint
ALTER TABLE "habits" DROP CONSTRAINT "habits_user_id_users_uuid_fk";
--> statement-breakpoint
ALTER TABLE "investments" DROP CONSTRAINT "investments_user_id_users_uuid_fk";
--> statement-breakpoint
ALTER TABLE "readings" DROP CONSTRAINT "readings_user_id_users_uuid_fk";
--> statement-breakpoint
ALTER TABLE "sessions" DROP CONSTRAINT "sessions_user_id_users_uuid_fk";
--> statement-breakpoint
ALTER TABLE "transactions" DROP CONSTRAINT "transactions_user_id_users_uuid_fk";
--> statement-breakpoint
DO $$ BEGIN
